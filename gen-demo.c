...
static void generate_demo() {
  ...
  add_periodic(r, Monday, h(9), h(12), start, end,
               "Rezerwacja poniedziałek 9:00-12:00.");
  add_periodic(r, Wednesday, h(12), h(14), start, end,
               "Rezerwacja środa 12:00-14:00.");
